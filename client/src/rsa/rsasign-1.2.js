...
// use cryptojs hashfuncs instad of pajhome.org.us/crypt/md5
var _RSASIGN_HASHHEXFUNC = [];
_RSASIGN_HASHHEXFUNC['sha1'] =      function(s){return CryptoJS.SHA1(s).toString();};
_RSASIGN_HASHHEXFUNC['sha256'] =    function(s){return CryptoJS.SHA256(s).toString();}
_RSASIGN_HASHHEXFUNC['sha512'] =    function(s){return CryptoJS.SHA512(s).toString();}
_RSASIGN_HASHHEXFUNC['md5'] =       function(s){return CryptoJS.MD5(s).toString();};
_RSASIGN_HASHHEXFUNC['ripemd160'] = function(s){return CryptoJS.RIPEMD160(s).toString();};
